			...
			<div class="modal" @dragover.prevent @drop.prevent="onDrop">
				...
				<div class="modal-body">
					...
					<div class="format-tabs">
						<button v-for="fmt in formats" :key="fmt.id" class="fmt-tab" :class="{ active: activeFormat === fmt.id }"
					...
					<div class="drop-zone" :class="{ dragging: isDragging, 'has-file': !!fileName }"
						@dragenter="isDragging = true" @dragleave="isDragging = false" @dragover.prevent @drop.prevent="onDrop"
						@click="fileInput?.click()">
						<input ref="fileInput" type="file" accept=".yml,.yaml" style="display: none" @change="onFileChange" />
					...
					<div class="paste-wrap">
						...
						<textarea v-model="pastedYaml" class="paste-area"
							placeholder="name: My Workflow&#10;jobs:&#10;  build:&#10;    runs-on: ubuntu-latest&#10;    steps:&#10;      - name: Run tests&#10;        run: npm test"
							spellcheck="false" @input="clearFile" />
					</div>
					...
					<div v-if="preview" class="preview-panel">
						...
						<div class="preview-tasks">
							<div v-for="t in preview.tasks" :key="t.id" class="preview-task">
								...
								<span v-if="t.metadata?.gha_action" class="pt-note"
