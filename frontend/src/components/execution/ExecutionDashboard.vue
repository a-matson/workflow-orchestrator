	...
	<div class="execution-dashboard">
		...
		<div class="exec-header">
			...
			<div class="exec-actions">
				<button v-if="execution.status === 'failed'" class="btn-retry" @click="$emit('retry')">
					↺ Retry
				</button>
				<button v-if="execution.status === 'running'" class="btn-cancel" @click="$emit('cancel')">
					◼ Cancel
				</button>
		...
		<Transition name="fade">
			<div v-if="selectedTask" class="task-detail">
				...
				<div class="detail-body">
					...
					<div v-if="selectedTask.started_at" class="detail-row">
