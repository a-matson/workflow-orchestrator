	...
	<div v-if="result.issues.length > 0 || showStats" class="validation-panel">
		...
		<div v-if="showStats && result.valid" class="stats-bar">
			<span class="stat-item"
				><span class="stat-val">{{ result.stats.taskCount }}</span> tasks</span
			>
			<span class="stat-sep">·</span>
			<span class="stat-item"
				><span class="stat-val">{{ result.stats.edgeCount }}</span> edges</span
			>
			<span class="stat-sep">·</span>
			<span class="stat-item"
				><span class="stat-val">{{ result.stats.rootCount }}</span> roots</span
			>
			<span class="stat-sep">·</span>
			<span class="stat-item"
				><span class="stat-val">{{ result.stats.maxDepth }}</span> levels deep</span
			>
